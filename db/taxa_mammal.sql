insert into taxa_mammal (tx_name_de,tx_name_en,tx_name_lat) values
('Meeressäuger unbestimmt','Marine mammal sp.','Mammalia'),
...
('Weißseitendelfin','Atlantic white-sided dolphin','Lagenorhynchus acutus');
